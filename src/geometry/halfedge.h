...
public:
    ...
    */
    ...
    /*
        ...
        mesh
    */
    std::optional<EdgeRef> connect_vertices(HalfedgeRef h0, HalfedgeRef h1);
    ...
    */
    void bevel_face_positions(const std::vector<Vec3>& start_positions, FaceRef face,
                              float tangent_offset, float normal_offset, float last_tangent_offset, float last_normal_offset);
